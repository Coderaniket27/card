          ...
          <div className="Input-Align">
            ...
            <div className="Button-align">
              <div className="button-book">
                <button onClick={handle} style={{ width: "80px" }}>
                  Search
                </button>
              </div>
            </div>
          ...
          <div ref={ref} className="Card1">
            ...
            <div className="Card-Detail">
              <div style={{ paddingLeft: "140px" }}>
                {visible ? <b>{data.name}</b> : ""}
              </div>
              <div style={{ paddingLeft: "140px", color: "blue" }}>
                {visible ? <b>{data.member}</b> : ""}
              </div>
              <div style={{ paddingLeft: "140px" }}>
                {visible ? <b>{data.date}</b> : ""}
              </div>
              <div
                style={{ paddingTop: "1px", paddingLeft: "0px", color: "red" }}
              >
                <b>8789654084,9110188345,7488679011</b>
              </div>

              <div style={{ paddingLeft: "70px" }}>
                <strong>info@nirogsansar.com</strong>
              </div>
            </div>
          </div>
        </div>
